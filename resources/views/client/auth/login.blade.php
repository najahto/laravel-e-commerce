                ...
                <div class="login-card mb-3 ">
                    ...
                    <form action="#" class="info">
                        ...
                        <div class="form-group">
                            ...
                            <input id="password" type="password" class="form-control text-left px-3" placeholder="">
                        </div>
                    </form>
                    <div class="signin-row">
                        <div class="login-btn">
                            <a href="checkout.html" class="btn btn-primary py-3 px-4">Sign In</a>
                        </div>
                    ...
                    <div class="footer">
                        <p>
                            Doesn't have account ? <a href="{{ route('register') }}">Register Here</a>
                        </p>
                    </div>
                </div>
